...
const OrderInfo: FC = () => {
  ...
  const ingredientsData: IIngredient[] = [];
  ...
  if (ingredients && ingredientsList) {
    ...
    ingredients.forEach((item) => {
      ...
      if (ingredientsCount[item] === undefined) {
        ...
        const ingredientToAdd = ingredientsList.find(element => element._id === item);
        ingredientToAdd && ingredientsData.push(ingredientToAdd);
      } else {
